...
A visual planning tool for creating custom donut boards using live edge slabs for weddings and events.

## Features

- **Interactive Board Designer**: Visualize your donut board layout in real-time
- **Customizable Measurements**: Configure all dimensions including:
...
3. Start planning your donut board

## Use Cases

- Planning wedding donut walls
- Custom donut board builds for events
